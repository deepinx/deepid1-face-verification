...
def read_csv_pair_file(csv_file):
    ...
    with open(csv_file, "r") as f:
        for line in f.readlines():
            ...
            p1 = '../deepid1/' + p1.replace('\\','/')
            p2 = '../deepid1/' + p2.replace('\\','/')
...
def load_data():
    with open('../deepid1/data/dataset.pkl', 'rb') as f:
...
if __name__ == '__main__':
    print('reading data from test_set.csv ...')
    testX1, testX2, testY = read_csv_pair_file('data/test_set.csv')
    print('reading data from valid_set.csv ...')
    validX, validY = read_csv_file('data/valid_set.csv')
    print('reading data from train_set.csv ...')
    ...
    print('writing data to dataset.pkl ...')
